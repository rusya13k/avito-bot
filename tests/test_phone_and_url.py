...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("9151234567", "+79151234567"),  # 10 digits, начина с 9 — мобильный
        ("+7 (***) ***-**-**", None),  # скрытые номер
        ("+1 415 555 0123", "+14155550123"),  # иностранный
        ("415-555-0123", "+74155550123"),  # 10 digits -> +7
        ("123", None),
        ("", None),
        (None, None),
    ],
...
def test_extract_phones_finds_multiple():
    text = (
        ...
        "Также есть +1 415 555 0123 (не российские)."
    )
